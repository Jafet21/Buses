    ...
    <body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
        ...
        <div id="about" class="container-fluid">
            <div class="row">
                <div class="col-sm-8">
                    <h2>Conózcanos</h2><br>
                    <h4>Company es un servicio que ofrece las rutas de autobuses en el Gran Área Metropolitana. Puedes conocer las rutas, paradas, tarifas, comentarios y quejas de nuestros usuarios además de poder acceder a la información de las compañias de Autobuses.  </h4><br>
        ...
        <div class="container-fluid bg-grey">
            <div class="row">
                ...
                <div class="col-sm-8">
                    ...
                    <h4><strong>MISIÓN:</strong> Nuestra Misión es facilitar las rutas,tarifas, paradas de autobuses de la meseta central, para todas aquellas personas que utilizan a diario el transporte público como el bus. Facilitando a todos nuestros usuarios poder compartir sus experiencias y poder observar los comentarios de los demas usuarios y hacer más placentero su viaje. </h4><br>
                    <h4><strong>VISION:</strong> Nuestra Visión es dirigirnos a ser una empresa que pueda facilitar la información de las empresas autobuseras para todo el público en general, dando una experiencia mas placentera al usuario. 
                        </h4>
                </div>
            </div>
        </div>
        ...
        <div id="registrese" class="container-fluid">
            <div class="row">
                <div >
                    <h2>Registrese </h2><br>
                    <h4>Ingrese sus datos personales, así como la de su empresa autobusera.</h4><br>
                </div>
                        ...
                        <ul class="list-group">
                            <li class="list-group-item">
                                ...
                                <div class="form-group">
                                    ...
                                    <div >
                                        <input type="nombre" class="form-control" id="telefonoEmpresa" placeholder="Teléfono empresarial" name="telefonoE">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div>
        ...
        <div id="servicios" class="container-fluid text-center">
            ...
            <div class="row slideanim">
                ...
                <div class="col-sm-4">
                    <i  class="fa logo-small">&#xf2c3;</i>
                    <h4>Información</h4>
                    <p>Información de la empresa autobusera que frecuenta.</p>
                </div>
            </div>
            <br><br>
            <div class="row slideanim">
        ...
        <div id="ciudades" class="container-fluid text-center bg-grey">
            ...
            <div class="row text-center slideanim">
                <div class="col-xs-6 col-sm-3">
                    <div class="thumbnail">
                        <img src="../imagenes/san jose.jpg" alt="San José" width="400" height="300">
            ...
            <div id="myCarousel" class="carousel slide text-center" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="item active">
                        <h4>"La manera mas rápida de viaja de Heredia a San José es por la ruta de Tibas!"<br><span>Felipe Jiménez</span></h4>
                    </div>
                    <div class="item">
